...
class AdminProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $pics = Pic::all();
        return view('Admin.Project.index', compact('projects', 'pics'));
    }
    ...
    {
       $pics = Pic::all();
       return view('Admin.Project.create', ['pic' => $pics]);
    }
    ...
    public function store(Request $request)
    {
       ...
       return redirect()->route('Admin.Project.index',['pic' => $data['pic_id']]);
    }
    ...
    public function edit($proj_id)
    {
        ...
        $pics = Pic::all();
        return view(('Admin.Project.edit'), compact('project'), ['pics' => $pics]);
    }
